...
var dynamicIndex = 0;
function createDynamicName(value) {
    var newName = "_DYN_";
    var lastUpper = false;
    ...
    if (!value.length || newName.length > 25) {
    ...
    function generateInternalConstants(theOptions) {
        ...
        if (newValues.length > 0) {
            ...
            newValues.forEach((name) => {
                if (name) {
                    generatedConstants += "export const " + createDynamicName(name.value) + " = \"" + name.value + "\";  // Count: " + name.count + "\n";
                }
            });
