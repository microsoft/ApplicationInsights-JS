/*!
 * Application Insights JavaScript SDK - Web, 2.0.0
    ...
    var ApplicationInsights = /** @class */ (function () {
        ...
        */
        ApplicationInsights.prototype.sendExceptionInternal = function (exception, customProperties, systemProperties) {
            var exceptionPartB = new Exception(this._logger, exception.error, exception.properties, exception.measurements, exception.severityLevel, exception.id).toInterface();
        ...
        ApplicationInsights.Version = "2.0.0"; // Not currently used anywhere
