/*!
 * Application Insights JavaScript SDK - Web, 2.5.7
...
(function (global, factory) {
    ...
    var CoreUtils = /** @class */ (function () {
        ...
        CoreUtils.objKeys = function (obj) {
            ...
            if (!_isFunction$1(obj) && (!_isObject(obj) || obj === null)) {
                throw new TypeError('objKeys called on non-object');
            }
            var result = [];
            for (var prop in obj) {
                if (_hasOwnProperty$1(obj, prop)) {
                    result.push(prop);
                }
            }
            if (hasDontEnumBug) {
                ...
                for (var lp = 0; lp < dontEnumsLength; lp++) {
                    if (_hasOwnProperty$1(obj, dontEnums[lp])) {
        ...
        CoreUtils.hasOwnProperty = _hasOwnProperty$1;
        /**
         * Checks if the passed of value is a function.
         * @param {any} value - Value to be checked.
         * @return {boolean} True if the value is a boolean, false otherwise.
         */
        CoreUtils.isFunction = _isFunction$1;
        /**
         * Checks if the passed of value is a function.
         * @param {any} value - Value to be checked.
         * @return {boolean} True if the value is a boolean, false otherwise.
    ...
    /*!
     * Application Insights JavaScript SDK - Channel, 2.5.7
     * Copyright (c) Microsoft and contributors. All rights reserved.
     */
    /*
        ...
        function Sender() {
            ...
            dynamicProto(Sender, _this, function (_self, _base) {
                ...
                function _setupTimer() {
                    if (!_timeoutHandle) {
                        var retryInterval = _retryAt ? Math.max(0, _retryAt - Date.now()) : 0;
        ...
        if (resourceEntry) {
            ...
            if (serverTiming) {
                ...
                _arrForEach$1(serverTiming, function (value, idx) {
                    ...
                    _arrForEach$1(_objKeys(value), function (key) {
                        var val = value[key];
    ...
    var AjaxMonitor = /** @class */ (function (_super) {
            ...
            dynamicProto(AjaxMonitor, _this, function (_self, base) {
                _self.initialize = function (config, core, extensions, pluginChain) {
                    if (!_self.isInitialized()) {
                        ...
                        _arrForEach$2(_objKeys$1(defaultConfig_1), function (field) {
        ...
        AjaxMonitor.getEmptyConfig = function () {
            ...
            _arrForEach$2(_objKeys$1(emptyConfig), function (value) {
...
//# sourceMappingURL=ai.2.5.7.js.map
