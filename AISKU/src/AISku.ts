...
export class AppInsightsSku implements IApplicationInsights {
    ...
    constructor(snippet: Snippet) {
        ...
        if (isServerSideRender()) {
            // In SSR, return a minimal no-op implementation
            // This prevents the rendering from getting stuck
            const noopFunc = () => {};
            
            // Set up a dummy snippet to prevent errors
            this.snippet = snippet || {} as any;
            
            // Define minimal required methods to prevent errors
            // These won't actually do anything in SSR environments
            this.getCookieMgr = () => null;
            this.track = Object.assign(noopFunc, {
                event: noopFunc,
                exception: noopFunc,
                metric: noopFunc,
                trace: noopFunc,
                pageView: noopFunc,
                pageViewPerformance: noopFunc,
                startTrackPage: noopFunc,
                stopTrackPage: noopFunc,
                startTrackEvent: noopFunc,
                stopTrackEvent: noopFunc,
                addTelemetryInitializer: noopFunc
            }) as any;
            this.flush = noopFunc;
            this.onunloadFlush = noopFunc;
            this.setAuthenticatedUserContext = noopFunc;
            this.clearAuthenticatedUserContext = noopFunc;
            this.loadAppInsights = noopFunc;
            this.trackEvent = noopFunc;
            this.startTrackEvent = noopFunc;
            this.stopTrackEvent = noopFunc;
            this.trackPageView = noopFunc;
            this.startTrackPage = noopFunc;
            this.stopTrackPage = noopFunc;
            this.trackException = noopFunc;
            this.trackTrace = noopFunc;
            this.trackMetric = noopFunc;
            this.trackPageViewPerformance = noopFunc;
            this.trackDependencyData = noopFunc;
            this.addTelemetryInitializer = noopFunc;
            this.updateSnippetProperties = noopFunc;
            this.setInstrumentationKey = noopFunc;
            ...
            this.getSKUDefaults = () => ({}) as any;

            // Define dummy versions of readonly properties
            (this as any).pluginVersionStringArr = [];
            (this as any).pluginVersionString = '';
            (this as any).core = {};
            (this as any).context = {};
            (this as any).appInsights = {};
            
            // Define a dummy config to prevent errors
            (this as any).config = { instrumentationKey: '', connectionString: '', extensions: [] };
