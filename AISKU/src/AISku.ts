...
import {
    ...
    IOTelSpanOptions, IPlugin, IReadableSpan, ISpanScope, ITelemetryInitializerHandler, ITelemetryItem, ITelemetryPlugin,
    ITelemetryUnloadState, ITraceApi, ITraceProvider, IUnloadHook, UnloadHandler, WatcherFunction, _eInternalMessageId, _throwInternal,
...
function _initOTel(sku: AppInsightsSku, traceName: string, onEnd: (span: IReadableSpan) => void): ILazyValue<IOTelApi> {
    ...
    sku.core.setTraceProvider(createTraceProvider(sku, traceName, otelApi, onEnd));
