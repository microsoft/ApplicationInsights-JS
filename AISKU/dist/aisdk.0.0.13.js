...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./Initialization */ "./amd/bundle/Initialization.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, Initialization_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    "use strict";
    var AppInsightsSDK = /** @class */ (function () {
        function AppInsightsSDK() {
        }
        AppInsightsSDK.Initialize = function (aiConfig, instanceName) {
            try {
                var appInsightsLocal = void 0;
                ...
                if (typeof window !== "undefined" && typeof JSON !== "undefined") {
                    ...
                    if (window[aiName] === undefined) {
                        ...
                        var defaultConfig = Initialization_1.ApplicationInsights.getDefaultConfig(aiConfig.config);
                        appInsightsLocal = new Initialization_1.ApplicationInsights({ config: defaultConfig });
                    }
                    else {
                        // this is the typical case for browser+snippet
                        var snippet = window[aiName] || {};
                        // overwrite snippet with full appInsights
                        appInsightsLocal = new Initialization_1.ApplicationInsights(snippet);
        ...
        return AppInsightsSDK;
    }());
    exports.AppInsightsSDK = AppInsightsSDK;
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! applicationinsights-core-js */ "./node_modules/applicationinsights-core-js/bundle/applicationinsights-core-js.js"), __webpack_require__(/*! applicationinsights-analytics-js */ "./node_modules/applicationinsights-analytics-js/bundle/applicationinsights-analytics-js.js"), __webpack_require__(/*! applicationinsights-common */ "./node_modules/applicationinsights-common/bundle/applicationinsights-common.js"), __webpack_require__(/*! applicationinsights-channel-js */ "./node_modules/applicationinsights-channel-js/bundle/applicationinsights-channel-js.js"), __webpack_require__(/*! applicationinsights-properties-js */ "./node_modules/applicationinsights-properties-js/bundle/applicationinsights-properties-js.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, applicationinsights_core_js_1, applicationinsights_analytics_js_1, applicationinsights_common_1, applicationinsights_channel_js_1, applicationinsights_properties_js_1) {
    ...
    var ApplicationInsights = /** @class */ (function () {
        function ApplicationInsights(snippet) {
        ...
        ApplicationInsights.prototype.loadAppInsights = function () {
        ...
        ApplicationInsights.prototype.emptyQueue = function () {
            ...
            try {
                ...
                this.core.logger.throwInternal(applicationinsights_core_js_1.LoggingSeverity.WARNING, applicationinsights_core_js_1._InternalMessageId.FailedToSendQueuedTelemetry, "Failed to send queued telemetry", properties);
            }
        };
        ...
        //}
        ApplicationInsights.prototype.addHousekeepingBeforeUnload = function () {
            // Add callback to push events when the user navigates away
            if (!this.config.disableFlushOnBeforeUnload && ('onbeforeunload' in window)) {
                var performHousekeeping = function () {
                    ...
                    this.core.getTransmissionControls().forEach(function (element) {
                        if (element.length > 0) {
                            element.forEach(function (e) { return e.flush(true); });
                        }
                    });
        ...
        ApplicationInsights.getDefaultConfig = function (configuration, identifier) {
            if (!configuration) {
                configuration = {};
            }
