    ...
    public registerTests() {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.ok(objIs(this._ai.core, otelApi.core), "OTel API core should be the same as the SDK core");
                ...
                Assert.ok(objIs(otelApi.core.config, this._ai.config), "OTel API config should be the same as the SDK config");
                Assert.ok(objIs(otelApi.core.config, this._ai.core.config), "OTel API config should be the same as the SDK core config");
