        ...
        this.testCase({
            ...
            test: () => {
                ...
                if (provider) {
                    ...
                    Assert.ok(isFunction(this._ai.activeSpan), "Should have activeSpan method");
    ...
    private addIsAvailableTests(): void {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.ok(isFunction(this._ai.activeSpan), "Available provider should have activeSpan");
                Assert.ok(isFunction(this._ai.setActiveSpan), "Available provider should have setActiveSpan");
                Assert.ok(isFunction(this._ai.core.activeSpan), "Available core should have activeSpan");
        ...
        this.testCase({
            ...
            test: () => {
                ...
                if (provider) {
                    ...
                    const activeSpan = this._ai.activeSpan();
                    ...
                    Assert.equal(activeSpan, this._ai.core.activeSpan(), "Active span from core should match active span from SDK");
                }
        ...
        this.testCase({
            ...
            test: () => {
                ...
                if (provider) {
                    ...
                    // Test activeSpan
                    Assert.doesNotThrow(() => {
                        const active = this._ai.activeSpan();
