...
export class AISKUSizeCheck extends AITestClass {
    private readonly MAX_RAW_SIZE = 125;
    private readonly MAX_BUNDLE_SIZE = 125;
    private readonly MAX_RAW_DEFLATE_SIZE = 52;
    private readonly MAX_BUNDLE_DEFLATE_SIZE = 52;
