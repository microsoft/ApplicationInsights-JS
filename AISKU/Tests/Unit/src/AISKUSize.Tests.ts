...
export class AISKUSizeCheck extends AITestClass {
    private readonly MAX_RAW_SIZE = 158;
    private readonly MAX_BUNDLE_SIZE = 158;
    private readonly MAX_RAW_DEFLATE_SIZE = 64;
    private readonly MAX_BUNDLE_DEFLATE_SIZE = 64;
