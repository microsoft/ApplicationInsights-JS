...
export class AISKUSizeCheck extends AITestClass {
    private readonly MAX_RAW_SIZE = 172;
    private readonly MAX_BUNDLE_SIZE = 172;
    private readonly MAX_RAW_DEFLATE_SIZE = 69;
    private readonly MAX_BUNDLE_DEFLATE_SIZE = 69;
