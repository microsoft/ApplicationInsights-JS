...
export class AISKUSizeCheck extends AITestClass {
    private readonly MAX_RAW_SIZE = 126;
    private readonly MAX_BUNDLE_SIZE = 126;
    private readonly MAX_RAW_DEFLATE_SIZE = 51;
    private readonly MAX_BUNDLE_DEFLATE_SIZE = 51;
    private readonly rawFilePath = "../dist/es5/applicationinsights-web.min.js";
    // Automatically updated by version scripts
    private readonly currentVer = "3.0.2";
