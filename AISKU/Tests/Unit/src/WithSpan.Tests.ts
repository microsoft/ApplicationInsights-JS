    ...
    private addTests(): void {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                withSpan(this._ai.core, testSpan!, function(this: ISpanScope) {
                    ...
                    traceCtxInsideWithSpan = this.core.getTraceCtx(false);
                    
                    // Get span context from the span
                    spanContextInsideWithSpan = this.span.spanContext();
                    
                    // Get active span
                    activeSpanInsideWithSpan = this.core.activeSpan ? this.core.activeSpan() : null;
                });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                withSpan(ai.core, outerSpan!, function(this: ISpanScope) {
                    outerTraceCtx = this.core.getTraceCtx(false);
                    ...
                    withSpan(ai.core, innerSpan!, function(this: ISpanScope) {
                        innerTraceCtx = this.core.getTraceCtx(false);
                    ...
                    const restoredTraceCtx = this.core.getTraceCtx(false);
        ...
        this.testCase({
            ...
            test: () => {
                ...
                withSpan(ai.core, parentSpan!, function(this: ISpanScope) {
                    ...
                    const traceCtx = this.core.getTraceCtx(false);
        ...
        this.testCase({
            ...
            test: () => {
                ...
                withSpan(ai.core, testSpan!, function(this: ISpanScope) {
                    traceCtxInside = this.core.getTraceCtx(false);
                });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                if (provider) {
                    provider.setActiveSpan(outerSpan!);
                }
        ...
        this.testCase({
            ...
            test: () => {
                ...
                if (provider) {
                    provider.setActiveSpan(contextSpan!);
                }
        ...
        this.testCase({
            ...
            test: () => {
                ...
                withSpan(ai.core, level1Span!, function(this: ISpanScope) {
                    const level1TraceCtx = this.core.getTraceCtx(false);
                    ...
                    withSpan(ai.core, level2Span!, function(this: ISpanScope) {
                        const level2TraceCtx = this.core.getTraceCtx(false);
