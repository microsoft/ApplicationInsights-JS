> Note: Angular Plugin is moved to its own repo [here](https://github.com/microsoft/applicationinsights-angularplugin-js). This Plugin is deprecated. Please refer to the new repo for usage instructions, and open issue there.
