...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        "use strict";
        ApplicationInsights.Version = "0.22.10";
        /**
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                ApplicationInsights.DataLossAnalyzer.enabled = new ApplicationInsights.SplitTest().isEnabled(this.config.instrumentationKey, 10);
