...
| excludeRequestFromAutoTrackingPatterns | string[] \| RegExp[] | undefined | If defined, Ajax or Fetch requests URL matches the regex patterns are not autocollected. Default is undefined. |
