...
| excludeRequestFromAutoTrackingPropertyName | string | undefined | If defined, Ajax or Fetch requests with the `<PropertyName>: true` are not autocollected. Default is undefined. |
