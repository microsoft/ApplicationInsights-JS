...
| excludeRequestFromAutoTrackingRegex | string[] \| RegExp[] | undefined | If defined, Ajax or Fetch requests URL matches the regex in this array are not autocollected. Default is undefined. |
