...
import { Base } from './Telemetry/Common/Base';
...
import { Util, _InternalLogging, _InternalMessageId, LoggingSeverity, RequestHeaders } from 'applicationinsights-common';
...
export class Sender {
     ...
     */
    public send(envelope: IEnvelope) {
        try {
