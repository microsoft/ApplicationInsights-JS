...
import { Util, IConfig, _InternalLogging, LoggingSeverity, _InternalMessageId, _InternalLogMessage } from 'applicationinsights-common';
...
export class Initialization {
    ...
    public loadAppInsights() {
        ...
        var appInsights = new AppInsights(this.config);
