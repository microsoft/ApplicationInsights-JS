...
import { IWatcherHandler, WatcherFunction } from "../../interfaces/AppInsights/config/IDynamicWatcher";
import { _IDynamicConfigHandlerState } from "../../interfaces/AppInsights/config/_IDynamicConfigHandlerState";
