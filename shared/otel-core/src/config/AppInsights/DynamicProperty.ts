...
import { IWatcherHandler, _IDynamicDetail } from "../../interfaces/AppInsights/config/IDynamicWatcher";
import { _IDynamicConfigHandlerState, _IDynamicGetter } from "../../interfaces/AppInsights/config/_IDynamicConfigHandlerState";
