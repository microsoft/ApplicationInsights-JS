...
import { ICachedValue, arrSlice, fnApply, getDeferred, isFunction, isObject, isPromiseLike, symbolFor } from "@nevware21/ts-utils";
...
const SPAN_CONTEXT_KEY: ICachedValue<symbol> = (/* @__PURE__ */ getDeferred(() => symbolFor(OTEL_SPAN_KEY)));
const SUPPRESS_TRACING_CONTEXT_KEY: ICachedValue<symbol> = (/* @__PURE__ */ getDeferred(() => symbolFor(OTEL_SUPPRESS_TRACING_KEY)));
 ...
 */
/*#__NO_SIDE_EFFECTS__*/
export function getContextSpan(context: IOTelContext): IReadableSpan | undefined {
    return context.getValue(SPAN_CONTEXT_KEY.v) as IReadableSpan | undefined;
}
 ...
 */
/*#__NO_SIDE_EFFECTS__*/
export function setContextSpan(context: IOTelContext, span: IOTelSpan | IReadableSpan): IOTelContext {
 ...
 */
/*#__NO_SIDE_EFFECTS__*/
export function setContextSpanContext(context: IOTelContext, spanContext: IDistributedTraceContext | IOTelSpanContext): IOTelContext {
    return setContextSpan(context, wrapSpanContext(context.api, spanContext));
}
 ...
 */
/*#__NO_SIDE_EFFECTS__*/
export function getContextActiveSpanContext(context: IOTelContext): IDistributedTraceContext | undefined {
