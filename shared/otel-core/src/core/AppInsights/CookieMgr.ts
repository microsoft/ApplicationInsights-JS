...
import { ICookieMgr, ICookieMgrConfig } from "../../interfaces/AppInsights/ICookieMgr";
...
import { getLocation, isIE } from "../../utils/AppInsights/EnvUtils";
import { getExceptionName, isNotNullOrUndefined, setValue, strContains } from "../../utils/AppInsights/HelperFuncsCore";
