...
import { _throwInternal, _warnToConsole } from "../../diagnostics/AppInsights/DiagnosticLogger";
import { _eInternalMessageId, eLoggingSeverity } from "../../enums/AppInsights/LoggingEnums";
import { SendRequestReason, TransportType } from "../../enums/AppInsights/SendRequestReason";
import { IDiagnosticLogger } from "../../interfaces/AppInsights/IDiagnosticLogger";
import { IProcessTelemetryUnloadContext } from "../../interfaces/AppInsights/IProcessTelemetryContext";
import {
    _IInternalXhrOverride, _ISendPostMgrConfig, _ISenderOnComplete, _ITimeoutOverrideWrapper
} from "../../interfaces/AppInsights/ISenderPostManager";
import { ITelemetryUnloadState } from "../../interfaces/AppInsights/ITelemetryUnloadState";
import { IXDomainRequest } from "../../interfaces/AppInsights/IXDomainRequest";
import { IPayloadData, IXHROverride, OnCompleteCallback, SendPOSTFunction } from "../../interfaces/AppInsights/IXHROverride";
import { getLocation, isBeaconsSupported, isFetchSupported, isXhrSupported, useXDomainRequest } from "../../utils/AppInsights/EnvUtils";
import {
    _getAllResponseHeaders, formatErrorMessageXdr, formatErrorMessageXhr, getResponseText, openXhr
