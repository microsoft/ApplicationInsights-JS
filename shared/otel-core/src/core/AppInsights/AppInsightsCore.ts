...
import { createDynamicConfig, onConfigChange } from "../../config/AppInsights/DynamicConfig";
import {
...
import { DiagnosticLogger, _InternalLogMessage, _throwInternal, _warnToConsole } from "../../diagnostics/AppInsights/DiagnosticLogger";
import { eEventsDiscardedReason } from "../../enums/AppInsights/EventsDiscardedReason";
import { ActiveStatus, eActiveStatus } from "../../enums/AppInsights/InitActiveStatusEnum";
import { _eInternalMessageId, eLoggingSeverity } from "../../enums/AppInsights/LoggingEnums";
import { SendRequestReason } from "../../enums/AppInsights/SendRequestReason";
import { TelemetryUnloadReason } from "../../enums/AppInsights/TelemetryUnloadReason";
import { TelemetryUpdateReason } from "../../enums/AppInsights/TelemetryUpdateReason";
import { eTraceHeadersMode } from "../../enums/AppInsights/TraceHeadersMode";
import { IAppInsightsCore, ILoadedPlugin } from "../../interfaces/AppInsights/IAppInsightsCore";
import { IChannelControls } from "../../interfaces/AppInsights/IChannelControls";
import { IChannelControlsHost } from "../../interfaces/AppInsights/IChannelControlsHost";
import { IConfiguration } from "../../interfaces/AppInsights/IConfiguration";
import { ICookieMgr } from "../../interfaces/AppInsights/ICookieMgr";
...
import { IPerfManager } from "../../interfaces/AppInsights/IPerfManager";
import { IProcessTelemetryContext, IProcessTelemetryUpdateContext } from "../../interfaces/AppInsights/IProcessTelemetryContext";
import { ITelemetryInitializerHandler, TelemetryInitializerFunction } from "../../interfaces/AppInsights/ITelemetryInitializers";
import { ITelemetryItem } from "../../interfaces/AppInsights/ITelemetryItem";
import { IPlugin, ITelemetryPlugin } from "../../interfaces/AppInsights/ITelemetryPlugin";
import { ITelemetryPluginChain } from "../../interfaces/AppInsights/ITelemetryPluginChain";
import { ITelemetryUnloadState } from "../../interfaces/AppInsights/ITelemetryUnloadState";
import { ITelemetryUpdateState } from "../../interfaces/AppInsights/ITelemetryUpdateState";
import { ILegacyUnloadHook, IUnloadHook } from "../../interfaces/AppInsights/IUnloadHook";
import { IConfigDefaults } from "../../interfaces/AppInsights/config/IConfigDefaults";
import { IDynamicConfigHandler, _IInternalDynamicConfigHandler } from "../../interfaces/AppInsights/config/IDynamicConfigHandler";
import { IWatchDetails, WatcherFunction } from "../../interfaces/AppInsights/config/IDynamicWatcher";
...
import { createContextManager } from "../../otel/api/context/contextManager";
import { createOTelSpanContext } from "../../otel/api/trace/spanContext";
import { createOTelTraceState } from "../../otel/api/trace/traceState";
import { findW3cTraceState } from "../../telemetry/W3cTraceState";
import { createUniqueNamespace } from "../../utils/AppInsights/DataCacheHelper";
import { getSetValue, isNotNullOrUndefined, proxyFunctionAs, proxyFunctions, toISOString } from "../../utils/AppInsights/HelperFuncsCore";
import { findW3cTraceParent } from "../../utils/AppInsights/TraceParent";
