...
import { getOpenTelemetryError, OTelInvalidAttributeError, OTelSpanError, throwOTelError, throwOTelInvalidAttributeError, throwOTelNotImplementedError, throwOTelSpanError } from "../../../../../src/otel-core-js";
