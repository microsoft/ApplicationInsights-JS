...
import { perfNow, isFunction, isString, isNumber, isBoolean, isObject, isArray, ICachedValue, getDeferred, strSubstr, objDefine, isNullOrUndefined, mathMin } from "@nevware21/ts-utils";
...
import { isTracingSuppressed, suppressTracing, unsuppressTracing, useSpan, withSpan } from "../../../../src/otel/api/trace/utils";
import { AppInsightsCore } from "../../../../src/core/AppInsightsCore";
import { ISpanScope, ITraceHost, ITraceProvider } from "../../../../src/interfaces/ai/ITraceProvider";
...
export class SpanTests extends AITestClass {
    ...
    // TODO: Change this to an OTelSdk instance when it's updated to effectively be a "core" instance that can be used in tests
        ...
        this.testCase({
            ...
            test: () => {
                ...
                tracer.startActiveSpan("auto-end-test", (span) => {
                    spanInsideCallback = span as IReadableSpan;
                    Assert.ok(!spanInsideCallback.ended, "Span should not be ended during callback");
            ...
            test: () => {
                ...
                const result = tracer.startActiveSpan("options-test", 
                    ...
                    (span) => {
                        ...
                        Assert.equal((span as IReadableSpan).kind, eOTelSpanKind.SERVER, "Span kind should match options");
                        (span as IReadableSpan).setAttribute("response.status", 200);
