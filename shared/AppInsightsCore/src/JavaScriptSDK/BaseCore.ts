...
import { ChannelControllerPriority, createChannelControllerPlugin, createChannelQueues, _IInternalChannels } from "./ChannelController";
...
export class BaseCore implements IAppInsightsCore {
    ...
    constructor() {
        ...
        let _channelControl: IChannelControls;
