...
import { ISdkStats, ISdkStatsState, IStatsBeatConfig } from "../JavaScriptSDK.Interfaces/ISdkStats";
...
export class AppInsightsCore<CfgType extends IConfiguration = IConfiguration> implements IAppInsightsCore<CfgType> {
    ...
    constructor() {
        ...
        dynamicProto(AppInsightsCore, this, (_self) => {
            ...
            _self.getSdkStats = (statsBeatState: ISdkStatsState) => {
    ...
    public getSdkStats(statsBeatState: ISdkStatsState): ISdkStats {
        // @DynamicProtoStub -- DO NOT add any code as this will be removed during packaging
        return null;
    }
