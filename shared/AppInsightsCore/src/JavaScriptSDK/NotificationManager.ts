...
import { SdkCoreNames, eSdkCoreNames } from "../JavaScriptSDK.Enums/SdkCoreNames";
    ...
    constructor(config?: IConfiguration) {
        ...
        dynamicProto(NotificationManager, this, (_self) => {
            ...
            _self.eventsSent = (events: ITelemetryItem[]): void => {
                _runListeners(_self.listeners, SdkCoreNames[eSdkCoreNames.eventsSent], true, (listener) => {
            ...
            _self.eventsDiscarded = (events: ITelemetryItem[], reason: number): void => {
                _runListeners(_self.listeners, SdkCoreNames[eSdkCoreNames.eventsDiscarded], true, (listener) => {
            ...
            _self.eventsSendRequest = (sendReason: number, isAsync: boolean): void => {
                _runListeners(_self.listeners, SdkCoreNames[eSdkCoreNames.eventsSendRequest], isAsync, (listener) => {
            ...
            _self.perfEvent = (perfEvent?: IPerfEvent): void => {
                if (perfEvent) {
                    ...
                    if (perfEvtsSendAll || !perfEvent.isChildEvt()) {
                        _runListeners(_self.listeners, SdkCoreNames[eSdkCoreNames.perfEvent], false, (listener) => {
