...
export interface IOTelTraceApi {
     ...
     */
    wrapSpanContext(spanContext: IDistributedTraceContext | IOTelSpanContext): IOTelSpan;

    /**
     * Returns true if this {@link IOTelSpanContext} is valid.
     * @return true if this {@link IOTelSpanContext} is valid.
     */
    isSpanContextValid(spanContext: IDistributedTraceContext |IOTelSpanContext): boolean;
