...
export { ISpanScope } from "./OpenTelemetry/interfaces/trace/ISpanScope";
...
export { isSpanContextValid, wrapSpanContext, isReadableSpan, suppressTracing, unsuppressTracing, isTracingSuppressed, useSpan, withSpan } from "./OpenTelemetry/trace/utils";
...
export {
    ...
    addHrTimes, hrTimeToMicroseconds, hrTimeToUnixNanos, zeroHrTime, nanosToHrTime, isTimeInput, isTimeInputHrTime, isTimeSpan
...
export {
    isSyntheticSource, serializeAttribute, getUrl, getPeerIp, getHttpMethod, getHttpUrl, getHttpHost, getHttpScheme,
