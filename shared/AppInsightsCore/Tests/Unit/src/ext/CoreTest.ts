...
import {
    AppInsightsExtCore as AppInsightsCore, IExtendedConfiguration, IPropertyStorageOverride,
    IExtendedTelemetryItem, EventLatency, FullVersionString
} from '../../../../src/ext/Index';
import { AppInsightsCore as AIInternalCore, IChannelControls, blockDynamicConversion } from '../../../../src/index';
