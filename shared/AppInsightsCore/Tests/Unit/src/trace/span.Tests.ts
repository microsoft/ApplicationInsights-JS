    ...
    public registerTests() {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                // Perform multiple runs to get a stable measurement (timing micro-benchmarks
                // are noisy on shared CI runners, so take the best-case overhead across runs)
                ...
                // withSpan should not add more than 15x overhead (generous threshold for CI runners)
