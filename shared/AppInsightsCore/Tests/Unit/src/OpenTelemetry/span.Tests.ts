...
import { isNullOrUndefined, mathMin, perfNow } from "@nevware21/ts-utils";
...
export class SpanTests extends AITestClass {
     ...
     */
    private _createTestTraceProvider(host: ITraceHost, onEnd?: (span: IReadableSpan) => void): ITraceProvider {
    ...
    public registerTests() {
        ...
        this.testCase({
            ...
            test: () => {
                // Arrange
                const core = this._setupCore();
                let initialActiveSpan = core.activeSpan();
                ...
                const providerActiveSpanBefore = core.activeSpan();
                ...
                const providerActiveSpanAfter = core.activeSpan();
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(activeSpan, parentSpan, "ActiveSpan() should return the parent span");
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(core.activeSpan(), initialActiveSpan, "Active span should be restored after execution");
            }
        });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(core.activeSpan(), initialActiveSpan, "Active span should be restored after completion");
            }
        });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.ok(testSpan, "Test span should be created");
                Assert.equal(core.activeSpan(), initialActiveSpan, "Just starting a span should not change active span");
                ...
                Assert.equal(core.activeSpan(), initialActiveSpan, "No active span should be restored");
            }
        });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(core.activeSpan(), initialActiveSpan, "No active span should remain after nested execution");
            }
        });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(core.activeSpan(), initialActiveSpan, "Active span should be restored");
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(result, "success", "Function should execute successfully");
                Assert.equal(capturedActiveSpan, testSpan, "Test span should be active during execution");
                Assert.equal(core.activeSpan(), initialActiveSpan, "No active span should be restored (was null)");
            }
        });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(executionTrace[1], "inner: inner-span", "Inner function should see inner span");
                Assert.equal(executionTrace[2], "outer-end: outer-span", "Outer function should see outer span restored");
                Assert.equal(core.activeSpan?.(), initialActiveSpan, "The initial active span should be restored after nested execution");
            }
        });
