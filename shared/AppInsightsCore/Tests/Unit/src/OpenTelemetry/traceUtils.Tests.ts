...
import { createDeferredCachedValue, isNullOrUndefined } from "@nevware21/ts-utils";
...
export class TraceUtilsTests extends AITestClass {
    ...
    private _setupTraceProvider(): void {
        const provider = createTraceProvider(
            this._core,
            "test-provider",
            createDeferredCachedValue(() => this._otelApi)
        );
    ...
    private addWithSpanTests(): void {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                const originalActiveSpan = this._core.activeSpan();
                ...
                withSpan(this._core, span, function() {
                    ...
                    coreActiveSpanDuringCallback = _self._core.activeSpan();
                ...
                const coreActiveSpanAfterCallback = this._core.activeSpan();
