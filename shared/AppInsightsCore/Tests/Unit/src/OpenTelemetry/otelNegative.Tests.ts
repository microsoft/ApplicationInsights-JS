...
import { createTraceApi } from "../../../../src/OpenTelemetry/trace/traceApi";
...
export class OTelNegativeTests extends AITestClass {
    ...
    private addCoreWithoutTraceProviderTests(): void {
        ...
        this.testCase({
            name: "Core.activeSpan: should return null when no trace provider is set",
            test: () => {
                // Act
                const activeSpan = this._core.activeSpan();
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.equal(activeSpan, mockSpan, "ActiveSpan() should return the same span object");
    ...
    private addTraceApiWithNullCoreTests(): void {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                const traceApi = createTraceApi(otelApi);
        ...
        this.testCase({
            ...
            test: () => {
                ...
                const activeSpan = this._core.activeSpan();
                Assert.equal(activeSpan, invalidSpan, "ActiveSpan() should return the invalid span");
            }
        });
        ...
        this.testCase({
            ...
            test: () => {
                ...
                // Validate activeSpan returns the span
                const activeSpan = this._core.activeSpan();
                Assert.equal(activeSpan, legacySpan, "ActiveSpan() should return the legacy span");
            }
        });
    }
    ...
    private addOTelApiWithInvalidContextTests(): void {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                Assert.ok(!callbackExecuted, "Callback should not execute when span is null");
                Assert.equal(result, undefined, "Should return undefined when no span created");
            }
        });
