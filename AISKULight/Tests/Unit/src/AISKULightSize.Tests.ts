...
export class AISKULightSizeCheck extends AITestClass {
    private readonly MAX_RAW_SIZE = 103;
    private readonly MAX_BUNDLE_SIZE = 103;
    private readonly MAX_RAW_DEFLATE_SIZE = 43;
    private readonly MAX_BUNDLE_DEFLATE_SIZE = 43;
