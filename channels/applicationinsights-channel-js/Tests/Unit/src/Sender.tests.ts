    ...
    public registerTests() {
        ...
        this.testCase({
            ...
            test: () => {
                ...
                QUnit.assert.equal(0, appInsightsCore.logger.queue.getSize(), "POST: No messageId logged");
                ...
                QUnit.assert.equal(1, appInsightsCore.logger.queue.getSize(), "POST: Correct messageId logged");
