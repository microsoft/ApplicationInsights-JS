...
const browserRollupConfigFactory = isProduction => {
  const browserRollupConfig = {
    input: "dist-esm/applicationinsights-teechannel-js.js",
    output: {
      file: "browser/applicationinsights-teechannel-js.js",
      banner: banner,
      format: "umd",
    ...
    plugins: [
      ...
      importCheck({ exclude: [ "applicationinsights-teechannel-js" ] }),
      nodeResolve({
        browser: false,
  ...
  if (isProduction) {
    browserRollupConfig.output.file = "browser/applicationinsights-teechannel-js.min.js";
